...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'ARSLAN_BOT',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ARSLAN_BOTZ;𝛥ARSLAN_MODZ;923237045919;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝛨𝛯𝑅𝛭𝛪𝑇;𝛥𝐷𝛪𝑇𝛨𝑌𝛥𝛮;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ARSLANBOTZ;𝛥ARSLANMODZ; : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '923237045919,0',
       DEBUG: DEBUG
};
